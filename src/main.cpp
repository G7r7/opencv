...
int main(int argc, char** argv )
{
    ...
    cv::Mat M(1500, 2500, CV_8UC3, cv::Scalar(255,255,255));
    ...
    while(solutions.getline(line, 1000) ){
        ...
        // Load image
        cv::Mat image = cv::imread(std::string("../ressources/frag_eroded/frag_eroded_") + std::to_string(fragment_solutions.index) + std::string(".png"));
